<?php include "inc/header.php"; ?>
	<section id="articles" class="container_12 clearfix">
		<div class="grid_9">
			<article>
				<h2><a href="article.php">Article Title Goes Right Here in this Place Article Title Goes Right Here in this Place</a></h2>
				<div class="meta clearfix">
					<div class="fl">
						August 24, 2013 <span>|</span> <a href="">Fitness</a>
					</div>
					<div class="fr">
						<span>Share:</span>
			...
			<article>
				<h2><a href="article.php">Squat Thrust Your Way to a New Life</a></h2>
				<div class="meta clearfix">
					<div class="fl">
						August 24, 2013 <span>|</span> <a href="">Fitness</a>
					</div>
				...
				<img src="http://static.oprah.com/images/money/201005/20100528-swimsuit-workout-squat-thrust-600x411.jpg">
				<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
				<p>A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.</p>
				<p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small line of blind text by the name of Lorem Ipsum decided to leave for the far World of Grammar.</p>
				<p>The Big Oxmox advised her not to do so, because there were thousands of bad Commas, wild Question Marks and devious Semikoli, but the Little Blind Text didn’t listen. She packed her seven versalia, put her initial into the belt and made herself on the way. When she reached the first hills of the Italic Mountains, she had a last view back on the skyline of her hometown Bookmarksgrove, the headline of Alphabet Village and the subline of her own road, the Line Lane. Pityful a rethoric question ran over her cheek, then</p>
			...
			<nav class="clearfix">
				<a href="" id="prev_link" class="fl">Previous</a>
				<a href="" id="prev_link" class="fr">Next</a>
			</nav>
		</div>
